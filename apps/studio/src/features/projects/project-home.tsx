                ...
                <div className="ec-project-card-actions">
                  <Button
                    ...
                    onClick={() => {
                      ...
                      if (name?.trim()) void projectStorageRuntime.renameProject(p.id, name).then(reload);
                    }}
                  >
                    Renombrar
                  </Button>
                  ...
                  {p.status === 'trashed' ? (
                    <Button
                      variant="ghost"
                      onClick={() => {
                        if (confirm('¿Eliminar permanentemente este proyecto?'))
                          void projectStorageRuntime.deleteProjectPermanently(p.id).then(reload);
                      }}
                    >
