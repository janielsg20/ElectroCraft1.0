...
## Reproducibility
- Deterministic `package-lock.json` was generated by GitHub Actions and committed in `1c09876e4f59911d9cd1af95f012c07595c59d3f`.
- This evidence commit intentionally triggers the second workflow run so package/source/live gates install only with `npm ci` from that committed lockfile.
