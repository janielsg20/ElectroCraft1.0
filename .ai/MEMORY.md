...
- El AppShell global usa 100dvh con scroll contenido en workspace; desktop usa Sidebar neutral de 256px, laptop compacta 64px y tablet un rail global de 56px con navegación completa en Sheet Radix. Móvil elimina el rail lateral y prioriza Topbar compacta + navegación inferior.
- El Topbar global usa 56px y el Statusbar global 24px; la jerarquía se expresa principalmente mediante espaciado, tipografía y bordes de 1px.
- El editor visual conserva cuatro regiones estables: Contexto 288px redimensionable 240–380px, Canvas dominante, Inspector 320px redimensionable 280–440px y Statusbar informativo global de 24px.
