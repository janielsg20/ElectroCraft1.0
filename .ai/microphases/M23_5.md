...
## Por qué existe
Esta microfase existe para **Contacts, Calendar y Biometrics** dentro de la responsabilidad de `F23`: mapear device capabilities. Debe cerrar una capacidad concreta y no abrir un subsystem paralelo.
...
Action node settings + Export permissions/config.

## Diseño visual exacto
Contacts/Calendar/Biometric configs and permission rationale.
