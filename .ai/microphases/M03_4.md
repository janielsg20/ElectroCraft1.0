...
Shell global superior; `Ayuda` y `Configuración` en extremo derecho.

## Diseño visual exacto
52px; left breadcrumb/proyecto/save, center tools contextuales, right Vista previa/Exportar/estado/Ayuda/Configuración.
