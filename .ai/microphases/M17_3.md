...
## Por qué existe
Esta microfase existe para **Blueprint group: Commerce y operaciones** dentro de la responsabilidad de `F17`: instalar Project Kits/Blueprints sin engines nuevos. Debe cerrar una capacidad concreta y no abrir un subsystem paralelo.
...
3. Admin screens from Refine config.
