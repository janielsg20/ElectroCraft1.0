...
## Por qué existe
Esta microfase existe para **ElectroCraftLayout/Style inspector** dentro de la responsabilidad de `F06`: añadir capacidades avanzadas/responsive sobre Puck. Debe cerrar una capacidad concreta y no abrir un subsystem paralelo.

## Resultado exacto
Al cerrar esta microfase, **ElectroCraftLayout/Style inspector** debe existir como capacidad real, integrada y verificable. No se acepta placeholder ni una implementación paralela al engine.
...
`Construir > Editor > Inspector > Diseño` y `Estilo`.

## Diseño visual exacto
Property groups compactos; box-model/layout controls, token/binding actions y reset/herencia visibles.
...
1. Layout/Style tabs editan canonical ElectroCraftLayout/ElectroCraftStyle.
