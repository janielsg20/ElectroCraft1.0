...
## Por qué existe
Esta microfase existe para **Expo SQLite + Drizzle stable schema** dentro de la responsabilidad de `F22`: generar runtime Expo/data/router/admin. Debe cerrar una capacidad concreta y no abrir un subsystem paralelo.
...
Generated Native data runtime; config visible only in Export Advanced/diagnostics.
...
5. No new table per Modelo de datos.
