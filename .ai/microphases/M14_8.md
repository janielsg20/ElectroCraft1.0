...
No new UI; audits Formularios.

## Diseño visual exacto
Validation/multistep/calc/upload/action/security E2E.
...
7. Mantén Form como ElectroCraftDocument + metadata.
8. Implementa RHF/Zod adapter para Studio/JS targets.
9. Conecta Data/Action submit.
10. Define portable validation constraints para server compilers.
11. Prueba conditional/multistep/error/submit.
