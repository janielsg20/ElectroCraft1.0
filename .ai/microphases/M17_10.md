...
## Por qué existe
Esta microfase existe para **Blueprint QA** dentro de la responsabilidad de `F17`: instalar Project Kits/Blueprints sin engines nuevos. Debe cerrar una capacidad concreta y no abrir un subsystem paralelo.
...
No new UI; audits Blueprints/Project Kits/Extensions.

## Diseño visual exacto
Install/conflict/uninstall/20-blueprint E2E.
