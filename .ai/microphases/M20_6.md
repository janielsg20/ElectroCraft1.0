...
## Por qué existe
Esta microfase existe para **Compatibility Screen** dentro de la responsabilidad de `F20`: analizar compatibilidad multi-target. Debe cerrar una capacidad concreta y no abrir un subsystem paralelo.
...
Target list 220–260 + diagnostics flex + right summary 300–340; row `Ir al origen`.
