...
## Por qué existe
Esta microfase existe para **Relaciones 1:1, 1:N, N:N** dentro de la responsabilidad de `F08`: modelar datos internos/workflow/indexes sin DDL dinámico. Debe cerrar una capacidad concreta y no abrir un subsystem paralelo.
...
`Datos > Modelos > <modelo> > Relaciones`.

## Diseño visual exacto
List/source-cardinality-target + detail Origen/Tipo/Destino/Inverso/Integridad/Permisos; small relationship visual optional.
