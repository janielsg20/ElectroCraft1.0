...
## Por qué existe
Esta microfase existe para **Performance hardening** dentro de la responsabilidad de `F27`: endurecer y proteger boundaries post-core. Debe cerrar una capacidad concreta y no abrir un subsystem paralelo.
...
No new screen; optional Debug/Report evidence.

## Diseño visual exacto
Performance budgets/report, not persistent analytics dashboard.
