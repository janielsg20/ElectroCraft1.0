...
## Por qué existe
Esta microfase existe para **Native source smoke test** dentro de la responsabilidad de `F22`: generar runtime Expo/data/router/admin. Debe cerrar una capacidad concreta y no abrir un subsystem paralelo.
...
No new UI; source/prebuild fixture.
