...
1. Define ElectroCraftComponentDefinition como metadata portable, no React component.
2. Define ElectroCraftLayout con modos semánticos.
3. Define ElectroCraftStyle y responsive/platform overrides.
4. No guardes Tailwind/NativeWind strings como fuente canónica.
5. Define version/migration de ComponentDefinition.
6. Define/actualiza schema TypeScript/Zod en domain/contracts.
7. Añade referencias IDs, versioning y validation.
8. Implementa serializer/migration si el shape persistido cambia.
9. Añade application-facing types sin importar engines.
10. Añade fixture round-trip y boundary test.
