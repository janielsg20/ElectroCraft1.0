...
`Construir > Editor > Canvas` + `Configuración > Editor > Guías y ajuste`.

## Diseño visual exacto
Rulers en edges Canvas, guías finas, snap indicators y distance labels; toggle toolbar/Settings.
