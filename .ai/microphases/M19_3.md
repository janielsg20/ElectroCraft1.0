...
## Por qué existe
Esta microfase existe para **Preview routing y 404** dentro de la responsabilidad de `F19`: previsualizar/diagnosticar runtime. Debe cerrar una capacidad concreta y no abrir un subsystem paralelo.
...
`Vista previa > selector Ruta`; 404 shown in preview content.

## Diseño visual exacto
Route combobox/search + address-like path display; 404 rendered from project template.
