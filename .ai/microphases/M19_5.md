...
## Por qué existe
Esta microfase existe para **Query/Action/State traces** dentro de la responsabilidad de `F19`: previsualizar/diagnosticar runtime. Debe cerrar una capacidad concreta y no abrir un subsystem paralelo.
...
`Vista previa > Debug > Consultas/Acciones/Estado`.

## Diseño visual exacto
Trace table/timeline with timestamp/source/duration/result; sensitive redacted.
