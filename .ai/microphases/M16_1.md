...
## Por qué existe
Esta microfase existe para **Project Design Tokens y themes** dentro de la responsabilidad de `F16`: gestionar diseño/templates/reutilización. Debe cerrar una capacidad concreta y no abrir un subsystem paralelo.
...
`Apariencia > Temas`, `Sistema de diseño` y `Tokens` del proyecto.

## Diseño visual exacto
Tema cards/list + token editor high-density; preview proyecto a la derecha/center.
