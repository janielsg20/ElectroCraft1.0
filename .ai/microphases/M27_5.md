...
## Por qué existe
Esta microfase existe para **Deployment Provider boundary** dentro de la responsabilidad de `F27`: endurecer y proteger boundaries post-core. Debe cerrar una capacidad concreta y no abrir un subsystem paralelo.
...
Provider cards/config/status; empty state emphasizes export works without provider.
