...
## Por qué existe
Esta microfase existe para **Accessibility hardening** dentro de la responsabilidad de `F27`: endurecer y proteger boundaries post-core. Debe cerrar una capacidad concreta y no abrir un subsystem paralelo.
...
No new screen; audits actual Studio/generated fixtures.

## Diseño visual exacto
Accessibility violations link to source screen/component; report in evidence.
