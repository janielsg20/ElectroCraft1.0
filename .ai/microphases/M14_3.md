...
`Formularios > <formulario> > Editor`.

## Diseño visual exacto
Canvas form; Context palette fields; Inspector Content/Validation/Conditions/Data/Style/Actions.
...
3. Content field types pueden mapear a ElectroCraftDataSchema.
4. Click-to-insert alternative en mobile.
5. Preview usa runtime form.
6. Mantén Form como ElectroCraftDocument + metadata.
7. Implementa RHF/Zod adapter para Studio/JS targets.
8. Conecta Data/Action submit.
9. Define portable validation constraints para server compilers.
10. Prueba conditional/multistep/error/submit.
