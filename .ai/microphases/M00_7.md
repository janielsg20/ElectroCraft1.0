...
6. Integra Refine Core headless mínimo con custom Native List/Create flow sobre ElectroCraftDataProvider; no TanStack DOM table.
...
10. Aísla el experimento; no importes implementación de producto no aprobada.
11. Define fixture mínimo reproducible.
12. Ejecuta la API OSS real que se está evaluando.
13. Mide el gap entre OSS y semántica ElectroCraft.
14. Documenta decisión/limitación/licencia/API usada.
15. Guarda logs/artifacts en evidence.
