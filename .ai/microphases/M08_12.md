...
## Por qué existe
Esta microfase existe para **Record CRUD y validation** dentro de la responsabilidad de `F08`: modelar datos internos/workflow/indexes sin DDL dinámico. Debe cerrar una capacidad concreta y no abrir un subsystem paralelo.
...
DataView/list + record form/detail; content type selector toolbar.
...
2. Antes de write, compila/ejecuta validation desde ElectroCraftDataSchema.
