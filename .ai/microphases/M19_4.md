...
## Por qué existe
Esta microfase existe para **Debug Console** dentro de la responsabilidad de `F19`: previsualizar/diagnosticar runtime. Debe cerrar una capacidad concreta y no abrir un subsystem paralelo.
...
`Vista previa > Debug` toggle opens resizable bottom/right panel.

## Diseño visual exacto
Tabs Datos/Estado/Consultas/Acciones/Permisos/Diagnósticos; technical values in mono only inside debug.
