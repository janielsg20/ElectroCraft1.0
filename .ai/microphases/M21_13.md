...
## Por qué existe
Esta microfase existe para **Web export build fixtures** dentro de la responsabilidad de `F21`: generar outputs Web/Local con dependencias mínimas. Debe cerrar una capacidad concreta y no abrir un subsystem paralelo.
...
No new UI; audits generated Web outputs.

## Diseño visual exacto
Install/typecheck/build reports.
