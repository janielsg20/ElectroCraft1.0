...
## Por qué existe
Esta microfase existe para **Location y Camera/Media** dentro de la responsabilidad de `F23`: mapear device capabilities. Debe cerrar una capacidad concreta y no abrir un subsystem paralelo.
...
Action node/Binding config + `Exportar > Permisos`.

## Diseño visual exacto
Location/Camera capability row with rationale and platform status.
