...
Generated Login/Register/Profile flows + `Roles > Usuarios`; no separate Auth engine UI.

## Diseño visual exacto
Auth screens use Form Design System; Studio user list/detail high-density.
