...
`Construir > Editor`; implementación en adapter, sin control visible nuevo salvo editor funcional.

## Diseño visual exacto
Monta Puck dentro del layout Editor; Canvas ocupa región central, sin chrome duplicado.
...
3. Mapea ElectroCraftDocument <-> Puck data.
