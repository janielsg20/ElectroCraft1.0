...
No new UI; runtime behind `Probar`/real events.

## Diseño visual exacto
Execution trace only in Debug/Test panel.
...
2. El adapter construye nodes/runtime objects a partir de ElectroCraftActionGraph; esos objects nunca se persisten.
