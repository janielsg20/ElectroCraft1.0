...
## Por qué existe
Esta microfase existe para **Native Listing/Filter/Form** dentro de la responsabilidad de `F22`: renderizar Native. Debe cerrar una capacidad concreta y no abrir un subsystem paralelo.
