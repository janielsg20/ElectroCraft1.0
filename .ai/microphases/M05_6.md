...
`Construir > Editor > Canvas`, al seleccionar/doble-click Text/RichText.

## Diseño visual exacto
Edición inline dentro del contenido con outline/focus sutil; toolbar RichText contextual cuando corresponda.
