...
## Por qué existe
Esta microfase existe para **Create/Edit/Detail with Refine RHF** dentro de la responsabilidad de `F15`: resolver Administración con Refine/TanStack. Debe cerrar una capacidad concreta y no abrir un subsystem paralelo.
...
`Administración > pantallas Crear/Editar/Detalle`.

## Diseño visual exacto
RecordForm uses Form semantics; Detail uses grouped fields/actions; responsive Sheet/route.
