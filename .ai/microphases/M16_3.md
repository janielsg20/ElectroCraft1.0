...
## Por qué existe
Esta microfase existe para **Display Conditions** dentro de la responsabilidad de `F16`: gestionar diseño/templates/reutilización. Debe cerrar una capacidad concreta y no abrir un subsystem paralelo.
...
`Construir > Plantillas > <plantilla> > Condiciones`.

## Diseño visual exacto
Rule rows Include/Exclude con source/operator/value; summary human-friendly.
