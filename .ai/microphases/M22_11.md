...
## Por qué existe
Esta microfase existe para **Native state/auth restore** dentro de la responsabilidad de `F22`: generar runtime Expo/data/router/admin. Debe cerrar una capacidad concreta y no abrir un subsystem paralelo.
...
Native runtime; user-visible auth screens are generated project UI.

## Diseño visual exacto
No Studio state duplicate.
