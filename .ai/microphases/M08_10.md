...
## Por qué existe
Esta microfase existe para **Taxonomías** dentro de la responsabilidad de `F08`: modelar datos internos/workflow/indexes sin DDL dinámico. Debe cerrar una capacidad concreta y no abrir un subsystem paralelo.
...
`Datos > Modelos > <modelo> > Taxonomías` y gestor de términos contextual.

## Diseño visual exacto
List izquierda + detail Identidad/Jerarquía/Modelos/Campos/Plantillas; term management link.
...
4. Attached Modelo de datoss son refs.
