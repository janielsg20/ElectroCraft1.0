...
## Por qué existe
Esta microfase existe para **ExportIR builder y validation** dentro de la responsabilidad de `F21`: generar outputs Web/Local con dependencias mínimas. Debe cerrar una capacidad concreta y no abrir un subsystem paralelo.
...
No direct screen; `Publicar > Exportar` uses result.

## Diseño visual exacto
Validation/diagnostics shown in Export Center.
