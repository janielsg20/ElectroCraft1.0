...
## Por qué existe
Esta microfase existe para **Native data/query adapters** dentro de la responsabilidad de `F22`: generar runtime Expo/data/router/admin. Debe cerrar una capacidad concreta y no abrir un subsystem paralelo.
...
Native runtime behind Listings/Forms/Administración; Debug fixture only.

## Diseño visual exacto
No separate Native query builder.
