...
## Por qué existe
Esta microfase existe para **Native core layout** dentro de la responsabilidad de `F22`: renderizar Native. Debe cerrar una capacidad concreta y no abrir un subsystem paralelo.
