...
## Por qué existe
Esta microfase existe para **Compatibility Analyzer** dentro de la responsabilidad de `F20`: analizar compatibilidad multi-target. Debe cerrar una capacidad concreta y no abrir un subsystem paralelo.
...
Target scan produces grouped result with counts Compatible/Adaptado/Advertencia/Bloqueado.
