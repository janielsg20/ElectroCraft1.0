...
## Por qué existe
Esta microfase existe para **NativeRenderer adapter y tokens** dentro de la responsabilidad de `F22`: renderizar Native. Debe cerrar una capacidad concreta y no abrir un subsystem paralelo.
...
1. Define NativeRenderer using canonical ElectroCraftDocument.
