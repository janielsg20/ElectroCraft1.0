...
## Por qué existe
Esta microfase existe para **Administración visual composition** dentro de la responsabilidad de `F15`: resolver Administración con Refine/TanStack. Debe cerrar una capacidad concreta y no abrir un subsystem paralelo.

## Resultado exacto
Al cerrar esta microfase, **Administración visual composition** debe existir como capacidad real, integrada y verificable. No se acepta placeholder ni una implementación paralela al engine.
...
`App > Administración > Editor de pantalla`.

## Diseño visual exacto
Puck Admin palette/context + Canvas de Administración + Inspector; Refine resuelve data lifecycle. No existe un segundo editor visual.
