...
## Por qué existe
Esta microfase existe para **PWA exporter** dentro de la responsabilidad de `F21`: generar outputs Web/Local con dependencias mínimas. Debe cerrar una capacidad concreta y no abrir un subsystem paralelo.
...
`Publicar > Exportar > PWA`.

## Diseño visual exacto
PWA manifest/offline config groups + compatibility.
