...
## Por qué existe
Esta microfase existe para **ElectroCraftStateDefinition** dentro de la responsabilidad de `F11`: resolver runtime state con Zustand. Debe cerrar una capacidad concreta y no abrir un subsystem paralelo.

## Resultado exacto
Al cerrar esta microfase, **ElectroCraftStateDefinition** debe existir como capacidad real, integrada y verificable. No se acepta placeholder ni una implementación paralela al engine.
...
Lista 300px izquierda; detail central con Nombre/Tipo/Ámbito/Valor inicial/Persistencia/Sensibilidad/Usos. Mobile list->detail.

## Texto visible en español
Estado y variables; Nueva variable; Tipo; Ámbito; Valor inicial; Persistencia; Sensible; Usado en.
...
6. Actualiza StateDefinition.
7. Implementa Zustand adapter/persistence only for JS runtimes.
8. Conecta Bindings/Actions/Debug.
9. Declara target scope mappings.
10. Prueba hydrate/migrate/sensitive state.
