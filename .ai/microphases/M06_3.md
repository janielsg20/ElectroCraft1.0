...
`Construir > Editor > Topbar > Plataforma` + `Inspector > Responsive/Avanzado`.

## Diseño visual exacto
Badges Web/Android/iOS por propiedad; diagnostics contextuales sin lanzar Compatibility full scan.
