...
## Por qué existe
Esta microfase existe para **Asset localization and generated docs** dentro de la responsabilidad de `F21`: generar outputs Web/Local con dependencias mínimas. Debe cerrar una capacidad concreta y no abrir un subsystem paralelo.
...
Export generation backend; result screen lists assets/docs.

## Diseño visual exacto
No separate media export screen.
