...
## Por qué existe
Esta microfase existe para **Preview E2E** dentro de la responsabilidad de `F19`: previsualizar/diagnosticar runtime. Debe cerrar una capacidad concreta y no abrir un subsystem paralelo.
...
No new UI; audits Vista previa/Debug.

## Diseño visual exacto
Route/runtime/simulator/trace isolation E2E.
...
7. Ejecuta runtime real, no screenshot/mock.
8. Conecta route/role/platform selectors.
9. Instrumenta traces sin exponer secrets.
10. Aísla effects de Preview cuando sea necesario.
11. Prueba Web/Admin/Native modes y Debug.
