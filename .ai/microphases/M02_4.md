...
1. Define ElectroCraftActionGraph portable, independiente de Rete classes.
2. Define ElectroCraftStateDefinition con scope/type/default/persistence/sensitivity.
3. Define ElectroCraftRouteDefinition y ElectroCraftNavigationDefinition; no React Router/Expo objects.
4. Define ElectroCraftRole/PermissionPolicy por capability/resource/field/route/action.
5. Define stable refs between screens/routes/actions/state.
6. Define versioning and migrations.
7. Contract-test domain package has no imports from Puck/Rete/Refine/Expo/AI SDK.
