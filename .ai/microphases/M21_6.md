...
## Por qué existe
Esta microfase existe para **Local project package** dentro de la responsabilidad de `F21`: generar outputs Web/Local con dependencias mínimas. Debe cerrar una capacidad concreta y no abrir un subsystem paralelo.
...
`Publicar > Exportar > Local`.

## Diseño visual exacto
Target config central + compatibility right + Generate.
