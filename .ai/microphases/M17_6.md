...
## Por qué existe
Esta microfase existe para **Blueprint group: Education/community** dentro de la responsabilidad de `F17`: instalar Project Kits/Blueprints sin engines nuevos. Debe cerrar una capacidad concreta y no abrir un subsystem paralelo.
