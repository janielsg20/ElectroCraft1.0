...
## Por qué existe
Esta microfase existe para **Administración E2E** dentro de la responsabilidad de `F15`: resolver Administración con Refine/TanStack. Debe cerrar una capacidad concreta y no abrir un subsystem paralelo.

## Resultado exacto
Al cerrar esta microfase, **Administración E2E** debe existir como capacidad real, integrada y verificable. No se acepta placeholder ni una implementación paralela al engine.
...
No new UI; audits Administración real views.

## Diseño visual exacto
CRUD/table/dashboard/Kanban/calendar/quick-edit/CSV E2E.
...
1. Create ElectroCraftDataModel.
2. Generate admin list/create/edit/detail.
3. Sort/filter/page/select.
4. Saved view.
5. Mobile card view.
6. Save/reopen backend document.
7. Define AdminScreen/resource semantics.
8. Usa Refine/TanStack para lifecycle/tabla, no reimplementes CRUD.
9. Conecta same DataSource/Permission services.
10. Construye view UI indicada.
11. Prueba CRUD/filters/bulk/permissions/mobile.
