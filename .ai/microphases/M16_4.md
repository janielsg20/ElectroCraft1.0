...
**Fase propietaria:** F16 — Temas, plantillas y componentes reutilizables

## Por qué existe
Esta microfase existe para **Saved blocks y global components** dentro de la responsabilidad de `F16`: gestionar diseño/templates/reutilización. Debe cerrar una capacidad concreta y no abrir un subsystem paralelo.
...
## Ubicación visual
Construir > Plantillas/Componentes o Apariencia > Themes/Design System.
...
`Construir > Componentes > Bloques guardados/Globales` y acción contextual `Guardar como reutilizable`.

## Diseño visual exacto
Grid/list de reutilizables con thumbnail/nombre/usos; global badge.

## Texto visible en español
Plantillas; Bloques guardados; Componentes globales; Temas; Sistema de diseño; Condiciones; Guardar como reutilizable.

## Ayuda contextual
Usa HelpRegistry `help.reuse`. Si esta microfase introduce un concepto nuevo, añade/actualiza su HelpDescriptor en español. La ayuda crítica no puede vivir solo en un tooltip.
...
1. Saved block = composite ElectroCraftDocument subtree package.
...
5. Detach supported.
6. Actualiza Theme/Template/Reusable canonical object.
7. Reutiliza Screen Composer para edición.
8. Implementa installer/save-as/ref usage.
9. Conecta manager UI.
10. Prueba reuse/global instances/import-export.
