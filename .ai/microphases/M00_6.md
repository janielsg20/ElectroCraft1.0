...
1. Crea ElectroCraftActionGraph mínimo Trigger -> Condition -> Data/Toast.
...
5. Verifica que ElectroCraftActionGraph no persista clases Rete.
6. Aísla el experimento; no importes implementación de producto no aprobada.
7. Define fixture mínimo reproducible.
8. Ejecuta la API OSS real que se está evaluando.
9. Mide el gap entre OSS y semántica ElectroCraft.
10. Documenta decisión/limitación/licencia/API usada.
11. Guarda logs/artifacts en evidence.
