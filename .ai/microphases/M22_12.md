...
## Por qué existe
Esta microfase existe para **Assets and route source generation** dentro de la responsabilidad de `F22`: generar runtime Expo/data/router/admin. Debe cerrar una capacidad concreta y no abrir un subsystem paralelo.
...
Generated Native source/assets; Export result report.

## Diseño visual exacto
No Studio file browser beyond Media.
