...
## Por qué existe
Esta microfase existe para **Conflict resolver y selective install** dentro de la responsabilidad de `F17`: instalar Project Kits/Blueprints sin engines nuevos. Debe cerrar una capacidad concreta y no abrir un subsystem paralelo.
...
Project Kit/Extension install wizard `Revisar conflictos`.

## Diseño visual exacto
Conflict list grouped by object kind; keep/replace/rename choices + impact summary.
