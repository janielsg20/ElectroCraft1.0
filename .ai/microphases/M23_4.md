...
## Por qué existe
Esta microfase existe para **Notifications, Haptics y Share** dentro de la responsabilidad de `F23`: mapear device capabilities. Debe cerrar una capacidad concreta y no abrir un subsystem paralelo.
...
Notification/Haptic/Share configs as action inspector groups.
