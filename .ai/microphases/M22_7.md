...
## Por qué existe
Esta microfase existe para **Expo project/runtime bootstrap** dentro de la responsabilidad de `F22`: generar runtime Expo/data/router/admin. Debe cerrar una capacidad concreta y no abrir un subsystem paralelo.
...
Generated Native project output and `Exportar > Android/iOS` diagnostics; no separate Studio route.

## Diseño visual exacto
No Native project-manager UI; generated source fixture.
...
5. README commands.
6. Mapea canonical components/navigation/data/state/actions a RN/Expo adapters.
7. No reutilices DOM components.
8. Implementa Expo Router/SQLite only from portable definitions.
9. Añade accessibility and device-safe behavior.
10. Prueba runtime fixture.
