...
`Construir > Editor`: insertar `Listado`; configurar `Inspector > Datos` y `Diseño`.

## Diseño visual exacto
Canvas shows repeated item template; Inspector selects Query/Collection, empty/loading template and layout.
