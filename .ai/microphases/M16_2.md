...
## Por qué existe
Esta microfase existe para **Template Manager** dentro de la responsabilidad de `F16`: gestionar diseño/templates/reutilización. Debe cerrar una capacidad concreta y no abrir un subsystem paralelo.
...
Filter chips por tipo + cards/list; `Nueva plantilla` primary. Abrir reutiliza Editor.
...
1. Kinds Page/Header/Footer/Single/Archive/404/Section/Modal/Administración.
2. List/filter/search/cards.
3. Templates usan ElectroCraftDocument.
