...
## Por qué existe
Esta microfase existe para **Frontend runtime preview** dentro de la responsabilidad de `F19`: previsualizar/diagnosticar runtime. Debe cerrar una capacidad concreta y no abrir un subsystem paralelo.
...
`Publicar > Vista previa > App Web`.

## Diseño visual exacto
Runtime fills center; toolbar route/role/platform/breakpoint; no editor outlines.

## Texto visible en español
Vista previa; App Web; Administración; Pantalla; Ruta; Rol simulado; Datos; Estado; Consultas; Acciones; Diagnósticos.
...
1. Renderiza ElectroCraftDocument usando runtime-web, no Puck editor chrome.
