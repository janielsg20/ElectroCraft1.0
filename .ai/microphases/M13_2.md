...
`Lógica > Acciones y workflows > <flujo>`.

## Diseño visual exacto
Rete graph canvas central; node palette/list left, inspector right, toolbar 44.

## Texto visible en español
Acciones y workflows; Nuevo workflow; Disparador; Acción; Condición; Datos; Estado; Navegación; Probar; Validar; Deshacer; Rehacer.
