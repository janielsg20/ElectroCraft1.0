...
## Por qué existe
Esta microfase existe para **Native preview/device workflow** dentro de la responsabilidad de `F23`: mapear device capabilities. Debe cerrar una capacidad concreta y no abrir un subsystem paralelo.
...
`Vista previa` Native mode / device workflow and Export diagnostics.

## Diseño visual exacto
Device preview/test instructions; no fake embedded device API.
