...
## Por qué existe
Esta microfase existe para **Content integrity y QA** dentro de la responsabilidad de `F08`: modelar datos internos/workflow/indexes sin DDL dinámico. Debe cerrar una capacidad concreta y no abrir un subsystem paralelo.
...
No crea UI; audita Modelos/Contenido/Taxonomías/Relaciones.

## Diseño visual exacto
CRUD/schema/integrity/workflow/indexer E2E.
