...
`Construir > Editor > Canvas/Capas`; toolbar contextual aparece con 2+ seleccionados.

## Diseño visual exacto
Selection outlines múltiples + compact contextual bar Agrupar/Alinear/Distribuir/Eliminar; resize handles solo compatibles.
