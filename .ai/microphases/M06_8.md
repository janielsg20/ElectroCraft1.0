...
No crea UI; audita Editor avanzado real.

## Diseño visual exacto
Matriz visual/responsive/keyboard de todas las herramientas avanzadas.
...
7. Extiende canonical Layout/Style/Responsive metadata.
8. Implementa overlay/control solo para gap no cubierto por Puck.
9. Conecta Inspector/Canvas sin almacenar transient geometry innecesaria.
10. Añade keyboard alternative a pointer interaction.
11. Prueba desktop/tablet/mobile y target diagnostics.
