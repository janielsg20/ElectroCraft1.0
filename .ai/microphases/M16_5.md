...
## Por qué existe
Esta microfase existe para **Theme/template import/export** dentro de la responsabilidad de `F16`: gestionar diseño/templates/reutilización. Debe cerrar una capacidad concreta y no abrir un subsystem paralelo.
...
`Apariencia > Temas` / `Construir > Plantillas > Más > Importar/Exportar`.

## Diseño visual exacto
Dialog/wizard archivo -> validación -> conflictos -> aplicar.
