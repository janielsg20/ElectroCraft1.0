...
`Construir > Editor > Canvas/Capas` al trabajar con componentes anidados.

## Diseño visual exacto
Drop target/outline nesting visual según Puck Slots; restricciones se explican en disabled state.
...
8. Canonical ElectroCraftDocument nunca persiste `zones` legacy ni Puck component runtime functions.
