...
import { Output, generateImage, generateText, stepCountIs, streamText, tool } from 'ai';
import { z } from 'zod';
...
if (typeof provider !== 'function' || typeof provider.image !== 'function') throw new Error('Google provider language/image factory missing');
...
for (const fn of [Output.object, generateImage, generateText, stepCountIs, streamText, tool, z.object]) {
